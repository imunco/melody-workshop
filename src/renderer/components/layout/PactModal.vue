  ...
  <material-modal :show="!isAgreePact || isShowPact" max-width="70%" :bg-close="isAgreePact" :close-btn="isAgreePact" @close="handleClose(false)">
    <main :class="$style.main">
      ...
      <div class="select scroll" :class="$style.content">
        ...
        <p><strong>发行身份：</strong>「旋律工坊」当前发行包由 <strong>奇点未码·Uncode Studio</strong> 维护与分发，与上游项目的 GitHub Release 渠道无必然对应关系；若你自第三方渠道获取本软件，请自行甄别来源可信度。</p><br>
        <p>词语约定：本协议中的“本项目”指「旋律工坊」桌面版（由 奇点未码·Uncode Studio 维护发行，软件代码主要派生自 LX Music / 洛雪音乐助手开源桌面版）；“使用者”指签署本协议的使用者；“官方音乐平台”指对本项目内置的包括酷我、酷狗、咪咕等音乐源的官方平台统称；“版权数据”指包括但不限于图像、音频、名字等在内的他人拥有所属版权的数据。</p><br>
