...
dd
  ...
  div
    ...
    .p.gap-top
      base-btn.btn(min @click="applyWorkshopLyricGradient") {{ $t('setting__melody_lyric_grad_btn') }}
dd
...
const useLyricColor = () => {
  ...
  const resetColor = () => {
    const defaultSetting = {
      ...
      'desktopLyric.style.lyricPlayedGradientEnd': '',
  ...
  const applyWorkshopLyricGradient = () => {
    updateSetting({
    ...
    setLyricUnplayColor('rgba(255, 255, 255, 0.88)')
    setLyricPlayedColor('rgb(61, 154, 150)')
    setLyricShadowColor('rgba(0, 0, 0, 0.32)')
    void dialog({
      message: window.i18n.t('setting__melody_lyric_grad_applied'),
