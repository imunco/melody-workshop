...
import { getBrowserWindowIconPath } from '@main/utils/windowIcon'
import { createTray as createSystemTray, createMenu as createTrayMenu } from '@main/modules/tray'
...
const winEvent = () => {
  ...
  browserWindow.on('close', event => {
    if (global.lx.isSkipTrayQuit || !global.lx.appSetting['tray.isToTray']) {
...
export const createWindow = () => {
  ...
  const winIcon = getBrowserWindowIconPath()
  if (winIcon) options.icon = winIcon
