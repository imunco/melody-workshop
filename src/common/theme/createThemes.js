...
const defaultThemes = [
  ...
  },
  {
    ...
    isDarkFont: false,
    config: {
      primary: 'rgb(72, 155, 148)',
      font: 'rgb(33, 33, 33)',
      '--color-app-background': 'rgba(72, 139, 143, 0.11)',
      '--color-main-background': 'rgba(255, 255, 255, 0.92)',
      '--color-nav-font': 'rgb(56, 130, 125)',
      '--background-image': 'none',
      '--background-image-position': 'center',
      '--background-image-size': 'cover',

      '--color-btn-hide': '#4db6ac',
      '--color-btn-min': '#e59885',
      '--color-btn-close': '#c75c5c',

      '--color-badge-primary': 'rgb(72, 155, 148)',
      '--color-badge-secondary': '#e59885',
      '--color-badge-tertiary': '#7fb5b0',
    },
  },
  {
    id: 'happy_new_year',
